...
基于 Claude / Claude Code 的四柱八字命理分析工具。集合**传统典籍**（渊海子平、子平真诠、滴天髓、穷通宝典、神峰通考）与**现代流派**（李涵辰新派、盲派、港台派、心理派），覆盖**八字分析、合婚、择日、姓名学、阳宅风水、三元九运、流月/流日断事、中医五运六气、六爻辅助、紫微交叉印证、改运实操、AI 时代职业匹配、创业八字、MBTI 性格对照、育儿命理、投资理财、专业咨询流程**等完整应用场景。
...
> 项目共含 **74 个 reference 文件**，覆盖从哲学总纲、经典赋文到风水玄学、流月流日、三元九运、中医养生、六爻紫微、误判避坑、改运实操、AI 时代职业、创业八字、MBTI 对照、育儿命理、投资理财、专业咨询流程的完整命理体系。
