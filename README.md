...
基于 Claude / Claude Code 的四柱八字命理分析工具。集合**传统典籍**（渊海子平、子平真诠、滴天髓、穷通宝典、神峰通考）与**现代流派**（李涵辰新派、盲派、港台派、心理派），覆盖**八字分析、合婚、择日、姓名学、阳宅风水、三元九运、流月断事、中医五运六气、六爻辅助**等完整应用场景。
...
> 项目共含 **65 个 reference 文件**，覆盖从哲学总纲、经典赋文到风水玄学、流月应期、三元九运、中医养生、六爻辅助、误判避坑的完整命理体系。
